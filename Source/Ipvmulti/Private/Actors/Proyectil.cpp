...
AProyectil::AProyectil()
{
	...
	{
		SphereComponent->OnComponentHit.AddDynamic(this, &AProyectil::OnProjectileImpact);
	}
...
void AProyectil::OnProjectileImpact(UPrimitiveComponent* HitComponent, AActor* OtherActor,
